...
class Counter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Counter', package: const $pb.PackageName(_omitMessageNames ? '' : 'counter'), createEmptyInstance: create)
