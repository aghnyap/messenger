...
import 'package:example/src/counter/counter_bloc.dart' as _i290;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i290.CounterBloc>(
        () => _i290.CounterBloc(gh<_i238.MessageBus<_i759.MessageChannel>>()));
    gh.singleton<_i773.CounterService>(() =>
        _i773.CounterService(gh<_i238.MessageBus<_i759.MessageChannel>>()));
    return this;
  }
}
