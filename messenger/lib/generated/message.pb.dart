...
enum Message_Type { request, response, broadcast, notSet }
...
class Message extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<Request>(7, _omitFieldNames ? '' : 'request',
        subBuilder: Request.create)
    ..aOM<Response>(8, _omitFieldNames ? '' : 'response',
        subBuilder: Response.create)
    ..aOM<Broadcast>(9, _omitFieldNames ? '' : 'broadcast',
...
class Request extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.String, $core.String>(2, _omitFieldNames ? '' : 'parameters',
        entryClassName: 'Request.ParametersEntry',
...
class Broadcast extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.String, $core.String>(2, _omitFieldNames ? '' : 'metadata',
        entryClassName: 'Broadcast.MetadataEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OS)
    ..aOM<$1.Any>(3, _omitFieldNames ? '' : 'data', subBuilder: $1.Any.create)
    ..hasRequiredFields = false;
